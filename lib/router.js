...
// 巨潮资讯
router.get('/cninfo/announcement/:code/:orgId/:category?', require('./routes/cninfo/announcement'));
router.get('/cninfo/stock_announcement/:code/:orgId', require('./routes/cninfo/stock_announcement'));
router.get('/cninfo/fund_announcement/:code/:orgId/:searchkey', require('./routes/cninfo/fund_announcement'));
